...
#'
#' The argument \code{zname} and \code{covM} are required when \code{ps.estimate} is not \code{NULL}.
#'
...
#'
#'
SumStat<- function(ps.formula,ps.estimate=NULL,trtgrp=NULL,Z=NULL,covM=NULL,zname=NULL,xname=NULL,data=NULL,weight="ATO",delta=0){
